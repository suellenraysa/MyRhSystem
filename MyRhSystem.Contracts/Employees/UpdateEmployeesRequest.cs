...
namespace MyRhSystem.Contracts.Employees
{
    public class UpdateEmployeesRequest
    {
        ...
        [StringLength(50)] public string? OrgaoEmissor { get; set; }
        public DateTime? RgEmissao { get; set; }
        [StringLength(20)] public string? TituloEleitor { get; set; }
        [StringLength(10)] public string? Zona { get; set; }
        [StringLength(10)] public string? Sessao { get; set; }
        [Required, StringLength(30)] public string CtpsNumero { get; set; } = "";
        [Required, StringLength(10)] public string CtpsSerie { get; set; } = "";

        // Contrato
        [Required, StringLength(20)] public string TipoContrato { get; set; } = "";
        public int? JornadaHoras { get; set; }
        [Required] public DateTime? Admissao { get; set; }
        [Required] public DateTime? DataExperiencia { get; set; }
        [Required] public DateTime? DataExperiencia1 { get; set; }

        public DateTime Contratacao { get; set; }
        public decimal Salario { get; set; }

        // Endereço
        [StringLength(255)] public string? Endereco { get; set; }
        [StringLength(10)] public string? Numero { get; set; }
        ...
        [StringLength(2)] public string? UF { get; set; }
        [StringLength(15)] public string? Cep { get; set; }
